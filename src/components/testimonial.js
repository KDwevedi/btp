...
//                 <div className="font-semibold text-gray-900">Ms X</div>
//                 <svg viewBox="0 0 2 2" width={3} height={3} aria-hidden="true" className="fill-gray-900">
//                   <circle cx={1} cy={1} r={1} />
//                 </svg>
//                 <div className="text-gray-600">CEO of Company</div>
//               </div>
//             </figcaption>
//           </figure>
//         </div>
...
function Testimonial ({name, title, testimony}) {
    return (
        ...
        <div class="h-full bg-gray-100 p-8 rounded">
          ...
          <p class="leading-relaxed mb-6">{testimony}</p>
    ...
    const data = [
        {
            ...
            testimony: "Bionic reading made an immediately noticable impact on my online reading speed. My daily necessary activity of consuming large amounts of technical information in a professional capacity has been enhanced."
        },
        {
            name: "User B",
            title: "Teacher",
            testimony: "Reading repetitive (and honestly subpar) assignments from students left me unable to focus on the next assignment in the pile. Creation of fixation points in text has enhanced my focus ability tremendously."
        }
    ]
...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="flex flex-wrap -m-4">
      ...
      <Testimonial name={data[1].name} title={data[1].title} testimony={data[1].testimony}/>
    </div>
  </div>
</section>
